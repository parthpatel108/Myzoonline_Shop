package com.logic.nibble.myzoonline.alert;
...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    public static final int SIMLE = 7;
    ...
    public SweetAlertDialog(Context context) {
        this(context, NORMAL_TYPE,MATERIAL);
    }

    public SweetAlertDialog(Context context, int alertType,int mAlertMode) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("PARTH DEBUG TYPE",String.valueOf(mAlertMode));;
//        if (mAlertMode == MATERIAL){
//            setContentView(R.layout.alert_dialog_v2);
//        }else{
...
//        }
    ...
    private void restore() {
        ...
        mConfirmButton.setBackgroundResource(R.drawable.alert_confirm_full);
...
//                    mConfirmButton.setBackgroundResource(R.drawable.red_button_background);
    ...
    public SweetAlertDialog setContentAlignment(int gravity){
